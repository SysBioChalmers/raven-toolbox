...
Real-data validation of [`localization.predict_localization`](../src/ravengem/localization/predict.py)
...
2. **Flattening**: the model is squashed into one compartment with
   [`manipulation.merge_compartments`](../src/ravengem/manipulation/compartments.py)
