...
and is adopted here as its canonical home; geckopy will import it from ravengem
once ravengem is published.

MATLAB-COMPAT: GECKO MATLAB and RAVEN ``expandModel.m`` use string manipulation
on grRules to detect and split isozymes. ravengem uses cobrapy's GPR AST
