...
Both functions are useful **independently of** :func:`ravengem.localization.predict_localization`:
...
def merge_compartments(
    ...
    * As a pre-step for localisation when the user does want RAVEN's
      ...
      :func:`ravengem.localization.predict_localization` with the full reaction list).
