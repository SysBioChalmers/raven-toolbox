...
The mirror of :mod:`ravengem.binaries` for *data*: a version-pinned registry of
...
error. Cache layout::
    ...
    $XDG_CACHE_HOME/ravengem/data/<dataset>-<version>/<filename>
    (or ~/.cache/ravengem/data/... if XDG_CACHE_HOME is unset)
"""
...
# Populated when ravengem publishes the KEGG artefacts as release assets.
_DATA_REGISTRY: dict = {}
...
def _data_cache_dir() -> Path:
    ...
    return Path(base) / "ravengem" / "data"
