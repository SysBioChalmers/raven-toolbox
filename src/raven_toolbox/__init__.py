"""raven_toolbox — Python counterpart of the RAVEN Toolbox, built on cobrapy.

raven_toolbox reuses cobrapy for simulation, standard analyses, SBML I/O, and model
...
try:
    __version__ = version("raven-toolbox")
