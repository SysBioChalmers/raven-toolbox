...
(:func:`raven_toolbox.init.ftinit`); ``get_init_model`` itself does not run the task layer.
"""
...
from raven_toolbox.init.init import run_init
from raven_toolbox.init.score import score_reactions_from_genes
