...
def test_canonical_gap_fill_breaks_tie_by_id():
    ...
    RA = cobra.Reaction("RA", lower_bound=0, upper_bound=1000); RA.add_metabolites({A: -1, M: 1})
    RB = cobra.Reaction("RB", lower_bound=0, upper_bound=1000); RB.add_metabolites({A: -1, M: 1})
    RP = cobra.Reaction("RP", lower_bound=0, upper_bound=1000); RP.add_metabolites({M: -1, P: 1})
