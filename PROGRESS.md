...
| _next_ | dFBA **not ported** — established Python implementations exist ([`dfba`](https://pypi.org/project/dfba/), [`reframed`](https://pypi.org/project/reframed/), [`mewpy`](https://pypi.org/project/mewpy/)); re-porting `runDynamicFBA` would duplicate well-maintained prior art (cheatsheet entry in PLAN §2.8). Phase 5 in scope ✅ done. |
